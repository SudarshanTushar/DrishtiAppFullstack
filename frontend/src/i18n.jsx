...
const translations = {
  en: {
    ...
    map: {
      ...
      safetyScan: "Safety Scan in Progress",
    ...
    sos: {
      ...
      scanning: "Actively scanning for nearby devices every 15 seconds",
      pausedMessage:
    ...
    network: {
      ...
      permissionsHint:
        "Enable Bluetooth Scan/Connect/Advertise, Nearby Wi‑Fi, and Location to start mesh.",
      grant: "Grant",
      meshStatus: "Mesh",
      running: "Running",
      starting: "Starting...",
  ...
  hi: {
    ...
    sos: {
      ...
      scanning: "हर 15 सेकंड में आसपास डिवाइस तलाश रहा है",
      pausedMessage:
  ...
  bn: {
    ...
    map: {
      ...
      safetyScan: "নিরাপত্তা স্ক্যান চলছে",
